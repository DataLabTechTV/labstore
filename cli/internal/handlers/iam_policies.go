...
func (h *IAMHandler) CreatePolicy(policyName, policyDocumentPath string) {
...
func (h *IAMHandler) AttachUserPolicy(userName, policyArn string) {
...
func (h *IAMHandler) AttachGroupPolicy(groupName, policyArn string) {
...
func (h *IAMHandler) GetPolicy(policyArn string) {
...
func (h *IAMHandler) ListAttachedUserPolicies(userName string) {
...
func (h *IAMHandler) ListAttachedGroupPolicies(groupName string) {
...
func (h *IAMHandler) DeletePolicy(policyArn string) {
...
func (h *IAMHandler) DetachUserPolicy(userName, policyArn string) {
...
func (h *IAMHandler) DetachGroupPolicy(groupName, policyArn string) {
